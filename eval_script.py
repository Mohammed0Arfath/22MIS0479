...
payload = {
    ...
    "mobileNo": "8667593576",
    "githubUsername": "Mohammed0Arfath"
}
...
# 1) Register
reg_keys = ["email", "name", "mobileNo", "githubUsername", "rollNo", "accessCode"]
code_reg, resp_reg = post(register_url, {k: payload[k] for k in reg_keys if k in payload})
